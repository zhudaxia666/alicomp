...
index18=random.sample(index15,3744)
index19=random.sample(index16,3269)
index20=random.sample(index17,2392)

# index15=random.sample(index15,700)
index16=random.sample(index16,65)
index17=random.sample(index17,402)


#   [ 6746. 5647. 7151. 7243. 6094.  4605. 6086. 7140. 5713. 7618.
#  6798. 5253.  7328. 5391.]  
index1=random.sample(index1,2746)
index2=random.sample(index2,1647)
index3=random.sample(index3,3151)
index4=random.sample(index4,3243)
index5=random.sample(index5,2094)
index6=random.sample(index6,605)
index7=random.sample(index7,2086)
index8=random.sample(index8,3140)
index9=random.sample(index9,1713)
index10=random.sample(index10,3618)
index11=random.sample(index11,2798)
index12=random.sample(index12,1253)
index13=random.sample(index13,3328)
index14=random.sample(index14,1391)
