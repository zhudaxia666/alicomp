...
class readData(object):
    def __init__(self):
        ...
        # self.path_training = "./data/shuffle_new_train8000.h5"
        self.path_validation = "./data/validation.h5"
        self.path_test = "./data/test.h5"
        self.path_test_2 = "./data/test_b.h5"
        # self.path_original_training='./data/new_train8000.h5'
        # self.path_newTrain='./data/label_0_6_11_14_train.h5'
        # self.path_shuffle_new_train8000='./data/shuffle_new_train8000.h5'

        self.fid_training = h5py.File(self.path_training,'r')
        # self.fid_shuffle_new_train8000=h5py.file(self.path_shuffle_new_train8000,'r')
        ...
        # self.fid_shuffle_new_train8000 = h5py.File(self.path_shuffle_new_train8000, 'w')
    ...
    # def h5py_shuffle(self):
    #     # new_train8000_sen1=self.fid_training['sen1']
    #     new_train8000_sen2=self.fid_training['sen2']
    #     new_train8000_label=self.fid_training['label']
    #
    #     length=new_train8000_sen2.shape[0]
    ...
    #     label_list = []
    #
    #     for i in range(new_train8000_sen2.shape[0]):
    #         # sen1_list.append(list(new_train8000_sen1[index[i]]))
    #         sen2_list.append(list(new_train8000_sen2[index[i]]))
    #         label_list.append(list(new_train8000_label[index[i]]))
    #     # self.fid_shuffle_new_train8000['sen1'] = np.array(sen1_list)
    #     self.fid_shuffle_new_train8000['sen2'] = np.array(sen2_list)
    #     self.fid_shuffle_new_train8000['label'] = np.array(label_list)
    #     self.fid_shuffle_new_train8000.close()
    ...
    def get_ND_mat(self, bias, resize=None, counts=1,num_conv=8,conv=True, train=False, test=False, label=0):
        re_mat = None
        if resize is None:
            ...
            sen2_data_3 = self.get_sen2_data(bias=bias, img_list=[3], counts=counts, train=train, test=test, label=label)[0][0,:,:]
            sen2_data_4 = self.get_sen2_data(bias=bias, img_list=[4], counts=counts, train=train, test=test, label=label)[0][0,:,:]
            sen2_data_5 = self.get_sen2_data(bias=bias, img_list=[5], counts=counts, train=train, test=test, label=label)[0][0,:,:]
            ...
            reshape_sen2_data_3 = sen2_data_3.reshape((1,size,size))
            reshape_sen2_data_4 = sen2_data_4.reshape((1,size,size))
            reshape_sen2_data_5 = sen2_data_5.reshape((1,size,size))
            ...
            nor_reshape_sen2_data_3 = self.op_mat(reshape_sen2_data_3, method="zero-order")
            nor_reshape_sen2_data_4 = self.op_mat(reshape_sen2_data_4, method="zero-order")
            nor_reshape_sen2_data_5 = self.op_mat(reshape_sen2_data_5, method="zero-order")
            ...
            if conv:
                ...
                sen2_nor_reshape_conv_3 = self.robinson(nor_reshape_sen2_data_3[0])
                sen2_nor_reshape_conv_4 = self.robinson(nor_reshape_sen2_data_4[0])
                sen2_nor_reshape_conv_5 = self.robinson(nor_reshape_sen2_data_5[0])
                ...
                sen2_nor_reshape_conv_3 = self.convolution(sen2_nor_reshape_conv_3)
                sen2_nor_reshape_conv_4 = self.convolution(sen2_nor_reshape_conv_4)
                sen2_nor_reshape_conv_5 = self.convolution(sen2_nor_reshape_conv_5)
                ...
                nor_reshape_sen2_data_3 = sen2_nor_reshape_conv_3.reshape((1, newsize, newsize))
                nor_reshape_sen2_data_4 = sen2_nor_reshape_conv_4.reshape((1, newsize, newsize))
                nor_reshape_sen2_data_5 = sen2_nor_reshape_conv_5.reshape((1, newsize, newsize))
            ...
            nor_reshape_sen2_data_3, nor_reshape_sen2_data_4, nor_reshape_sen2_data_5,\
            nor_reshape_sen2_data_6,nor_reshape_sen2_data_7,nor_reshape_sen2_data_8,nor_reshape_sen2_data_9), axis=0)
            
            # nor_reshape_sen1_data_4,nor_reshape_sen1_data_5,nor_reshape_sen1_data_exp_mat_1,\
            # nor_reshape_sen1_data_exp_mat_2,nor_reshape_sen1_data_exp_mat_3


            self.op_mat(sen2_data_0)
            del sen2_data_0, sen2_data_1, sen2_data_2, sen2_data_6, sen2_data_7, sen2_data_8, sen2_data_9, \
            sen2_data_3, sen2_data_4, sen2_data_5
            # sen1_data_0, sen1_data_1, sen1_data_2, sen1_data_3, sen1_data_4, sen1_data_5, sen1_data_6, \
            ...
            reshape_sen2_data_9,reshape_sen2_data_3, reshape_sen2_data_4, reshape_sen2_data_5
            # ,reshape_sen1_data_4,reshape_sen1_data_5,\
            ...
            nor_reshape_sen2_data_9,nor_reshape_sen2_data_3, nor_reshape_sen2_data_4, nor_reshape_sen2_data_5
            # ,nor_reshape_sen1_data_4,nor_reshape_sen1_data_5,\
